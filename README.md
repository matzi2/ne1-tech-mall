...
주식회사 엔이원텍 공식 쇼핑몰 **v0.2.11** (2026-08-23). 도메인: [NE1-TECH.CO.KR](https://ne1-tech.co.kr)
...
관리자 이메일로 로그인했을 때만 상단 노란 막대와 운영화면이 보입니다. GitHub 연결은 `/admin/github`에서 아이디와 Personal Access Token을 넣습니다. 계정 비밀번호·토큰은 git에 저장하지 않습니다. 다른 메일로는 쇼핑몰·마이페이지만 씁니다.
